...
<html>
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="60" >
        ...
        <fDi:form class="container-fluid bg-grey" action="user/insert.htm" modelAttribute="NguoiDung">
            <div class="sidebarct">
                ...
                <div class="col-sm-4">
                    <div class="panel-group">
                        <div class="panel panel-default">
                            ...
                            <button class="btn btn-default pull-left" type="submit">Insert</button>
                            </div>
                        </div>
                    </div>
                </div>
